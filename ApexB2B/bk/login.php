        ...
        <div class='grid justify-center'>
            <form id='login-form' action='".$_SERVER['PHP_SELF']."' method='post' onsubmit='return validateForm()' class='col-12 col-sm-8'>
                <div class='grid text-left'>
                    ...
                    <p>&nbsp;</p>
                    <p>We have been working hard to improve the APEX customer portal and are excited to announce that the NEW APEX Customer Portal is now live.</p>
                    <p>&nbsp;</p>
        <p>If need access to the new portal, please register to receive your new login information. Once you complete sign-up you will be contacted within 24 hours on next steps. If you have any questions, please contact us at <a href='mailto:aorder@apexfoot.com'>aorder@apexfoot.com</a>.</p>
                    <p>&nbsp;</p>
