        ...
        <div class="grid justify-center">
            <div class="col-12 col-sm-10 col-md-8 menu has-logo">
                <div class="grid justify-end">
                    <div class="col-2 col-bleed text-right"><a class="small" href="index.php">Return to Order Form</a></div>
                </div>
                <div class="logo"><a href="/index.php"><img src="/images/logo.jpg" alt="Apex"></a></div>
            <div class="logo"><a href="/index.php"><img src="/images/logo.jpg" alt="Apex"></a></div>
            <div class="grid">
                <h1 class="col-12 text-center">Thank You</h1>
                <p class="col-12">Thank you for your submission. You will recieve an email confirmation once your order has been processed.</p> 
            </div>
        </form>
        </div>
        </div>
