...
<body>
    <section class='grid-container site-form contact'>
        <div class='grid align-start'>
            <form id='login-form' action='".$_SERVER['PHP_SELF']."' method='post' onsubmit='return validateForm()' class='col-12 offset-0 col-sm-10 offset-1-sm col-lg-5 offset-7-lg has-logo'>
                <div class='logo'><a href='/index.php'><img src='images/logo.jpg' alt='Apex'></a></div>
                <div class='grid'>
                    <h2 class='col-12'>Enter your account number and email to<br />recover your password.</h2>
                    <p class='col-12'><strong>Don’t remember your account number?</strong> Please contact us.</p>
                    <p class='col-12'><a href='login.php'>Back to login</a></p>
                </div>
                <fieldset class='grid'>
                    <div class='col-12'>
